(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var PoseElement = (function (_super) {
        ...
        function PoseElement(props) {
            ...
            _this.getRefs = function () {
                ...
                if (typeof elementType === 'string' || reactIs_1(elementType)) {
    ...
    var mergeChildren = function (_a) {
        ...
        var groupChildren = groupProps.children, preEnterPose = groupProps.preEnterPose, enterPose = groupProps.enterPose, exitPose = groupProps.exitPose, flipMove = groupProps.flipMove, animateOnMount = groupProps.animateOnMount, propsForChild = __rest(groupProps, ["children", "preEnterPose", "enterPose", "exitPose", "flipMove", "animateOnMount"]);
        var children = [];
        ...
        leaving.forEach(function (key) {
            ...
            var newChild = cloneElement(child, __assign({ _pose: exitPose, onPoseComplete: removeFromTree(key), popFromFlow: flipMove }, propsForChild, filterChildProps(child.props)));
