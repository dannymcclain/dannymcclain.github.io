...
var mergeChildren = function (_a) {
    ...
    leaving.forEach(function (key) {
        ...
        var newChild = cloneElement$1(child, __assign({ _pose: exitPose, onPoseComplete: removeFromTree(key), popFromFlow: flipMove }, propsForChild, filterChildProps(child.props)));
